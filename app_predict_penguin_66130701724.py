...
st.write("Enter the penguin's physical characteristics, sex, and island below to predict its species.")

# Input fields for penguin's physical features, sex, and island
...
# Encode the sex and island input
...
if st.button("Predict Species"):
    ...
    if all(value > 0 for value in [culmen_length_mm, culmen_depth_mm, flipper_length_mm, body_mass_g]):
        # Prepare the input data as a numpy array (including encoded sex and island)
        input_data = np.array([[culmen_length_mm, culmen_depth_mm, flipper_length_mm, body_mass_g, sex_encoded, island_encoded]])
